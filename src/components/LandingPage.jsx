...
const baseInstitutes = [
  ...
  { id: 9, name: "מכללת HIT מכון טכנולוגי חולון", slug: "HitPage" },
  { id: 10, name: "שנקר", slug: "shenkar" },
  { id: 11, name: "SCE סמי שמעון", slug: "sami-shamoon" },
...
export default function LandingPage({ onSelectInstitute }) {
  ...
  const circleSpacing = isMobile ? 50 : 100;
  ...
  return (
    <div className="h-screen w-screen flex flex-col items-center justify-center bg-gradient-to-b from-sky-50 via-blue-300 to-sky-50 relative overflow-hidden">
